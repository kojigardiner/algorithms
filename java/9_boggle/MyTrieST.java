/******************************************************************************
 *  Compilation:  javac MyTrieST.java
 *  Execution:    java MyTrieST < words.txt
...
/**
 * The {@code MyTrieST} class represents an symbol table of key-value
...
public class MyTrieST<Value> {
    ...
    private void collect(Node x, StringBuilder prefix, String pattern, Queue<String> results) {
        ...
        if (d == pattern.length())
            return;
        char c = (char) (pattern.charAt(d) - 'A');
        if (c == '.') {
    ...
    /**
     * Unit tests the {@code MyTrieST} data type.
     *
